...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--data_root", default=str(proj_root / "data" / "lowN_1M2M_to_3M+"), help="Assay root directory.")
    parser.add_argument("--only_assay", default="")
    parser.add_argument("--train_log", default=str(base_dir / "training_log" / "lowN_1M2M_to_3M+"))
    parser.add_argument("--pred_output", default=str(base_dir / "output" / "lowN_1M2M_to_3M+"))
